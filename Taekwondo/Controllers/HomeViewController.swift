...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, iCarouselDataSource {
...
//        self.tkdCarousel.bounceDistance = 60
...
//        )
    ...
    func topBar() {
        ...
        if (iosVersion == "iPhone 8") {
            topView.frame = CGRect(x: 0, y: self.view.frame.origin.y, width: self.view.frame.size.width, height: 100)
        } else if (iosVersion == "iPhone 11 Pro") {
...
///        cell.textLabel!.text = "\(menuData[indexPath.row])"
    ...
    @objc func navigatetoAboutus() {
        ...
        let aboutusViewController = UINavigationController(rootViewController: aboutusVC)
    ...
    @objc func navigatetoContactus() {
        ...
        let contactusViewController = UINavigationController(rootViewController: contactusVC)
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    @objc func navigatetoVision() {
        ...
        let visionViewController = UINavigationController(rootViewController: visionVC)
        visionViewController.modalPresentationStyle = .fullScreen
        present(visionViewController, animated: true, completion: nil)
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    @objc func navigatetoMission() {
        ...
        let missionViewController = UINavigationController(rootViewController: missionVC)
        missionViewController.modalPresentationStyle = .fullScreen
        present(missionViewController, animated: true, completion: nil)
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    @objc func navigatetoLocationmap() {
        let locationmapVC = LocationmapViewController()
        let locationmapViewController = UINavigationController(rootViewController: locationmapVC)
        locationmapViewController.modalPresentationStyle = .fullScreen
        present(locationmapViewController, animated: true, completion: nil)
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    @objc func navigatetoCompetitions() {
        ...
        let competitionsViewController = UINavigationController(rootViewController: competitionsVC)
        competitionsViewController.modalPresentationStyle = .fullScreen
        present(competitionsViewController, animated: true, completion: nil)
    }

    @objc func navigatetoYearplan() {
        let yearplanVC = YearplanViewController()
        let yearplanViewController = UINavigationController(rootViewController: yearplanVC)
        yearplanViewController.modalPresentationStyle = .fullScreen
        present(yearplanViewController, animated: true, completion: nil)

    }
    @objc func navigatetoTrainingSchedules() {
        let trainingschedVC = TrainingSchedViewController()
        let trainingschedController = UINavigationController(rootViewController: trainingschedVC)
        trainingschedController.modalPresentationStyle = .fullScreen
        present(trainingschedController, animated: true, completion: nil)
    }
    @objc func navigatetoOlympics() {
        let olympicVC = OlympicsViewController()
        let olympicController = UINavigationController(rootViewController: olympicVC)
        olympicController.modalPresentationStyle = .fullScreen
        present(olympicController, animated: true, completion: nil)
    }
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    @objc func navigatetoRegistration() {
        ...
        let registerViewController = UINavigationController(rootViewController: registerVC)
    ...
    @IBAction func settingsNavigation(_ sender: UITapGestureRecognizer) {
        ...
        let setttingsViewController = UINavigationController(rootViewController: settingsVC)
        setttingsViewController.modalPresentationStyle = .fullScreen
        present(setttingsViewController, animated: true, completion: nil)
    }

    @IBAction func nationalsNavigation(_ sender: UITapGestureRecognizer) {
        swipedDown()
        let nationalsVC = NationalsTableViewController()
        let natioanlsViewController = UINavigationController(rootViewController: nationalsVC)
        natioanlsViewController.modalPresentationStyle = .fullScreen
        present(natioanlsViewController, animated: true, completion: nil)
    }
    ...
    @IBAction func TBBNavigation(_ sender: UITapGestureRecognizer) {
        ...
        let tbbVC = TBBCollectionViewController(collectionViewLayout: layout)
        let tbbViewController = UINavigationController(rootViewController: tbbVC)
        tbbViewController.modalPresentationStyle = .fullScreen
        present(tbbViewController, animated: true, completion: nil)
        
    }

    @IBAction func TBSNavigation(_ sender: UITapGestureRecognizer) {
        hideBars()
        let tbsVC = TbsViewController()
        let tbsViewController = UINavigationController(rootViewController: tbsVC)
        tbsViewController.modalPresentationStyle = .fullScreen
        present(tbsViewController, animated: true, completion: nil)
    }
    
    @IBAction func satelitesNavigation(_ sender: UITapGestureRecognizer) {
        let satelitesVC = SatelitesViewController()
        let satelitesViewController = UINavigationController(rootViewController: satelitesVC)
        satelitesViewController.modalPresentationStyle = .fullScreen
        present(satelitesViewController, animated: true, completion: nil)
    }

    @IBAction func promotionsNavigation(_ sender: UITapGestureRecognizer) {
        let promotionsVC = PromotionsViewController()
        let promotionsViewController = UINavigationController(rootViewController: promotionsVC)
        promotionsViewController.modalPresentationStyle = .fullScreen
        present(promotionsViewController, animated: true, completion: nil)
    }
